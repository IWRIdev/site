...
module Adminka
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ADMINKA_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Adminka::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Adminka::Action is included
      ...
      # Configure the code that will yield each time Adminka::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Adminka::Assets::Helpers
      end
    end
