...
module Iwrinet
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['IWRINET_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Iwrinet::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Iwrinet::Action is included
      ...
      # Configure the code that will yield each time Iwrinet::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Iwrinet::Assets::Helpers
      end
    end
